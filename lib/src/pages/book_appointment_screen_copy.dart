...
class BookAppointmentScreenCopy extends StatefulWidget {
  final double price;
  final bool isBottomButtonText;

  const BookAppointmentScreenCopy({Key? key, this.price = 00.00, this.isBottomButtonText = true}) : super(key: key);

  @override
  _BookAppointmentScreenCopyState createState() => _BookAppointmentScreenCopyState();
}

class _BookAppointmentScreenCopyState extends State<BookAppointmentScreenCopy> {
  int selectValue = 0;
