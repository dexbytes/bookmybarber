...
class AppString {
  ...
  String mobileVerificationHeading = "mobileVerificationHeading";
  String otpScreenHeading = "otpScreenHeading";
  String bookMyBarber = "bookMyBarber";
  String homeSubtitle = "homeSubtitle";
  String topCategories = "topCategories";
  String bestSalon = "bestSalon";
  String topServices = "topServices";
  String popularSalon = "popularSalon";
  String barberSpecialist = "barberSpecialist";
  String bookNow = "bookNow";
  String about = "about";
  String openingHours = "openingHours";
  String address = "address";
  String services = "services";
  String packageOffers = "packageOffers";
  String gallery = "gallery";
  String reviews = "reviews";
  String writeReview = "writeReview";
  String allReview = "allReview";
  String salonSpecialist = "salonSpecialist";
  String portfolio = "portfolio";
  String searchHint = "searchHint";
  String specialPackage = "specialPackage";
  String bookAppointment = "bookAppointment";
  String done = "done";
  String selectDate = "selectDate";
  String selectSpecialist = "selectSpecialist";
  String availableSlot = "availableSlot";
