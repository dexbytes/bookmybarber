...
class PriceTextRow extends StatelessWidget {
  ...
  const PriceTextRow({Key? key,
    ...
    this.rightTitleTextStyle = const TextStyle(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.white),
    this.rightTitleTextStyle1 = const TextStyle(fontSize: 18,fontWeight: FontWeight.w600,color: Color(0xFF00B2AE)),
