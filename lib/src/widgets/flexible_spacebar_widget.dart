...
/// [FlexibleSpaceBarWidget.createSettings], to convey sizing information down to the
/// [FlexibleSpaceBarWidget].
///
/// {@tool dartpad}
/// This sample application demonstrates the different features of the
/// [FlexibleSpaceBarWidget] when used in a [SliverAppBar]. This app bar is configured
/// to stretch into the overscroll space, and uses the
/// [FlexibleSpaceBarWidget.stretchModes] to apply `fadeTitle`, `blurBackground` and
...
class FlexibleSpaceBarWidget extends StatefulWidget {
  ...
  /// Defines how much the title is scaled when the FlexibleSpaceBarWidget is expanded
  ...
  /// [FlexibleSpaceBarWidget] when fully collapsed. `maxExtent` sets the maximum
  /// height of the resulting [FlexibleSpaceBarWidget] when fully expanded.
  /// `currentExtent` sets the scale of the [FlexibleSpaceBarWidget.background] and
  /// [FlexibleSpaceBarWidget.title] widgets of [FlexibleSpaceBarWidget] upon
  /// initialization. `scrolledUnder` is true if the [FlexibleSpaceBarWidget]
  ...
  ///    used to specify these settings to a [FlexibleSpaceBarWidget].
  ...
  @override
  State<FlexibleSpaceBarWidget> createState() => _FlexibleSpaceBarState();
}

class _FlexibleSpaceBarState extends State<FlexibleSpaceBarWidget> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        assert(
        settings != null,
        'A FlexibleSpaceBarWidget must be wrapped in the widget returned by FlexibleSpaceBarWidget.createSettings().',
        );
