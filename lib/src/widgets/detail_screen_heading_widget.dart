...
class DetailHeadingWidget extends StatelessWidget {
  ...
  const DetailHeadingWidget({Key? key,
    ...
    this.titleTextStyle = const TextStyle(fontSize: 26,fontWeight: FontWeight.w800,color: Colors.white),
    this.subtitleTextStyle = const TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color:Colors.white),
