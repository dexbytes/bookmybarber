...
class CommonTextFieldWithError extends StatelessWidget {
  CommonTextFieldWithError({
    ...
    this.hintText = 'Enter some text...', // set place holder text in text field
...
//    print('people icon $inputFieldSuffixIcon');
    ...
    switch (capitalization) {
      ...
      case CapitalizationText.words:
        ...
        break;
      case CapitalizationText.characters:
        capitalizationTemp = TextCapitalization.characters;
        break;
      ...
      child: Column(
        ...
        children: <Widget>[
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      errorStyle: errorStyle != null
                          ? errorStyle
                          : TextStyle(color: Colors.white), //change by Mohit to red to white
                      ...
                      enabledBorder: OutlineInputBorder(
                        ...
                        borderSide: errorText == null
                          ...
                          style:borderStyle ?? BorderStyle.solid,
                            ...
                            : BorderSide(
                          color: Colors.white, //change by Mohit to red to white
                          width: enabledBorderWidth ?? 1,
                          style: borderStyle ?? BorderStyle.solid,
                        ),
                      ),
          ...
          !isShowBottomErrorMsg
              ...
              : (errorMessages != '')
              ? Container(
              margin: EdgeInsets.only(right: errorLeftRightMargin * 2, left: errorLeftRightMargin * 2),
              height: errorMsgHeight??24,
              child: Padding(
                padding: EdgeInsets.only(top: 3.0, left: 10),
                child: Text(
                  errorMessages,
                  style: errorMessageStyle != null
                      ? errorMessageStyle
